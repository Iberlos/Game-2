...
//
//
//	vec3 dirLight = u_LightPos - v_SurfacePos.xyz;
...
//	float falloffPercent = pow(1-length(dirLight)/u_LightRange,2);
//
//	vec3 finalColor = v_Color.xyz * u_LightColor * (diffusePercent * falloffPercent + specularPercent);
...
void main()
{
	...
	vec3 finalColor = u_Color.xyz * totalDiffuse + totalSpecular;
