...
public:
    Vector3() {}
    Vector3(btVector3 btvec) { x = btvec.x(); y = btvec.y(); z = btvec.z(); }
...
inline Vector3 operator +(float scalar, const Vector3& vector) { return Vector3(scalar + vector.x, scalar + vector.y, scalar + vector.z); }
inline Vector3 operator -(float scalar, const Vector3& vector) { return Vector3(scalar - vector.x, scalar - vector.y, scalar - vector.z); }
//inline btVector3 operator =(btVector3 vecBullet, Vector3& vector) { return btVector3(vector.x, vector.y, vector.z); }
...
public:
    ...
    inline Vector4 operator +(const Vector4& o) const { return Vector4(this->x + o.x, this->y + o.y, this->z + o.z, this->w + o.w); }
    inline Vector4 operator -(const Vector4& o) const { return Vector4(this->x - o.x, this->y - o.y, this->z - o.z, this->w - o.w); }
    inline bool operator != (const Vector4& o) const { return !((this->x == o.x)&&(this->y == o.y)&&(this->z == o.z)&&(this->w == o.w)); }
